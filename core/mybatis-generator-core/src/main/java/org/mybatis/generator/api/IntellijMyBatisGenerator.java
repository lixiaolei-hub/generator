...
public class IntellijMyBatisGenerator {
     ...
     */
    public IntellijMyBatisGenerator(Configuration configuration, ShellCallback shellCallback,
     ...
     */
    public void generate(ProgressCallback callback, IntellijTableInfo tableInfo) throws SQLException,
    ...
    public void generate(ProgressCallback callback, Set<String> contextIds,
            Set<String> fullyQualifiedTableNames,IntellijTableInfo tableInfo) throws SQLException,
            IOException, InterruptedException {
     ...
     */
    public void generate(ProgressCallback callback, Set<String> contextIds,
            Set<String> fullyQualifiedTableNames, boolean writeFiles,IntellijTableInfo tableInfo) throws SQLException,
            IOException, InterruptedException {
...
//                    fullyQualifiedTableNames);
            context.introspectIntellijTables(callback, this.warnings, fullyQualifiedTableNames, tableInfo);
        }
