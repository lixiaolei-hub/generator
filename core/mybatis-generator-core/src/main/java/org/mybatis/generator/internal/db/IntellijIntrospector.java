...
public class IntellijIntrospector {
    ...
    public IntellijIntrospector(Context context,
                                JavaTypeResolver javaTypeResolver, List<String> warnings, IntellijTableInfo tableInfo) {
        super();
    ...
    private Map<ActualTableName, List<IntrospectedColumn>> getColumns(
        ...
        for (IntellijColumnInfo intellijColumnInfo : intellijTableInfo.getColumnInfos()) {
            ...
            ActualTableName atn = new ActualTableName(null,null,intellijTableInfo.getTableName());
